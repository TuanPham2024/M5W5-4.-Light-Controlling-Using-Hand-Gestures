...
class LightGesture:
    def __init__(self, model_path, device=False):
        ...
        self.height = 720
        self.width = 1280
        self.simulation_mode = not device  # Thêm flag simulation mode
        ...
        if self.device:
            try:
                ...
                print(f"Không thể kết nối hardware, chuyển sang chế độ simulation: {e}")
    ...
    def light_simulation(self, img, lights):#light_device(self, img, lights):
    ...
    def run(self):
        ...
        while cam.isOpened():
            ...
            cv2.resizeWindow('window', 1024, 760)
...
if __name__ == "__main__":
    model_path = "./models/model_02-12 05_11_NeuralNetwork_best" #"./models/model_02-11 15_19_NeuralNetwork_best"
    ...
    light = LightGesture(model_path, device=False) # Sửa code để chạy ở chế độ simulation
    light.run()
